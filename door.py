...
class Door:
    """
    Diese Klasse beschreibt eine Türe mit der Eig
    enschaft color (Farbe) und den Zuständen
    ...
    die Türe an ein Objekt vom Typ Door_lock (Türschloss).
    """
    # Mit dem Keyword def wird eine
    # Funktion bzw. eben ein Konstruktor deklariert.
    # Der Konstruktor trägt
    # IMMER den Namen __init__
    # und weist als ersten
    # Parameter den Wert self auf.
    # Danach folgen die Übergabeparameter,
    # deren Werte dann den Attributen zugewiesen werden.
    # Attribute können aber auch mit einem
    # fixen Wert initialisiert werden.
    ...
    # Nach den Konstruktoren folgen
    # Methoden, die eine Verarbeitung auslösen.
    # Danach folgen Methoden, die
    # auf ein Ereignis reagieren
    def open_the_door(self):
        """
        Methode für das öffnen der Türe.
        Das ist aber nur möglich,
        wenn die Türe nicht verriegelt ist.
        """
    ...
    def close_the_door(self):
        ...
        Das geht immer, auch wenn
        die Türe schon geschlossen
    ...
    def lock_the_door(self):
        ...
        Türschloss zuständig. Es weiss wie das geht.
        """
